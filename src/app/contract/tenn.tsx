  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      if (pdfMode === "original") {
        ...
        pdf.text("WEDDING PHOTOGRAPHY AGREEMENT", pageWidth / 2, yPos, {
          align: "center",
        });
        ...
        pdf.text(`Contract Date: ${today}`, pageWidth / 2, yPos, {
          align: "center",
        });
        ...
        yPos += 5;
        pdf.text(
          `Booking: ${dayjs(selectedProject.dateOfBooking).format(
            "MMMM D, YYYY"
          )}`,
          pageWidth / 2 + 5,
          yPos
          ...
          const eventTableData = events.map((event: any) => {
            ...
            return [
              `${dayjs(eventStart).format("MMM D, YYYY")}\n${dayjs(
                eventStart
              ).format("h:mm A")} - ${dayjs(eventEnd).format("h:mm A")}`,
              event.venue,
              event.assignment,
        ...
        pdf.setTextColor(128, 128, 128);
        const footerText =
          "This agreement is binding upon signing by both parties. Please retain a copy for your records.";
        pdf.text(footerText, pageWidth / 2, yPos, {
          align: "center",
            ...
            >
              ...
              >
                  ...
                  {merchantDetails?.merchantDetails?.logo && (
                    ...
                    >
                      <img
                        ...
                        alt={
                          merchantDetails.merchantDetails.businessName ||
                          "Business Logo"
                        }
                ...
                >
                  <Typography
                    variant="h6"
                    sx={{ fontWeight: 700, mb: 2, color: "#001C3D" }}
                  >
                    MONETARY AGREEMENT
                  </Typography>
                  <Typography variant="body2" sx={{ mb: 2, lineHeight: 1.8 }}>
                    This agreement is entered into between the Service Provider
                    and the Client for photography services as detailed in this
                    contract. The total package cost for all services, including
                    but not limited to photography coverage, editing, and
                    deliverables specified herein, amounts to <strong>₹</strong>
                    <strong
                      contentEditable
                  ...
                  <Typography variant="body2" sx={{ mb: 2, lineHeight: 1.8 }}>
                    A non-refundable booking deposit of <strong>30%</strong> of
                    the total package cost is required to secure the date and
                    confirm this booking. The remaining balance of{" "}
                    <strong>70%</strong> must be paid at least 7 days prior to
                    the event date. Payment can be made via bank transfer, UPI,
                    or any other mutually agreed method. Late payments may
                    result in postponement or cancellation of services as per
                    the cancellation policy outlined in this agreement.
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{
                  ...
                  >
                    Both parties acknowledge and agree to the monetary terms
                    stated above and commit to fulfilling their respective
                    financial obligations as outlined in this contract.
                  </Typography>
                </Box>
                ...
                <Box sx={{ mb: 4, pageBreakInside: "avoid" }}>
                  ...
                  <Grid container spacing={2}>
                    <Grid size={6}>
                      ...
                      <Typography variant="body2" sx={{ mb: 0.5 }}>
                        <strong>Email:</strong>{" "}
                        {merchantDetails?.merchantDetails?.email || "N/A"}
                      </Typography>
                    ...
                    <Grid size={6}>
                      ...
                      <Typography variant="body2">
                        ...
                        {dayjs(selectedProject.dateOfBooking).format(
                          "MMMM D, YYYY"
                        )}
                      </Typography>
                    </Grid>
                ...
                <Box sx={{ mb: 4 }}>
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • A non-refundable deposit of 30% of the total package
                      cost is required to confirm the booking.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The remaining balance must be paid at least 7 days
                      before the event date.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • All payments should be made via bank transfer or as
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Cancellations made 60+ days before the event: 50% refund
                      of deposit.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Cancellations made 30-59 days before: 25% refund of
                      deposit.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Cancellations made less than 30 days before: No refund.
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The photographer will arrive at the scheduled time and
                      stay for the agreed-upon duration.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Overtime charges will apply if coverage extends beyond
                      the agreed hours, at the rate specified in the package.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • We will make every effort to capture all important
                      moments, but specific shots cannot be guaranteed.
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • All images will be professionally edited and
                      color-corrected.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Edited photos will be delivered within the timeframe
                      specified in the deliverables section.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Photos will be delivered via online gallery or as
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The client receives a personal use license to print,
                      share, and post images on social media with proper credit.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Commercial use of images requires written permission
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The photographer will take utmost care with equipment
                      but is not liable for photos not taken due to camera
                      malfunction or circumstances beyond control.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Backup equipment will be available on-site to minimize
                      risks.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The photographer is not responsible for family disputes,
                      venue restrictions, or poor lighting conditions affecting
                      photo quality.
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • In case of extreme weather, natural disasters, illness,
                      or other unforeseen circumstances, the photographer will
                      make reasonable efforts to provide a replacement
                      photographer.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • If no replacement is available, the deposit will be
                      refunded in full.
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • The client must inform the photographer of any special
                      shots or family groupings required.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Digital files will be retained for a minimum of 6 months
                      after delivery.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • After this period, the photographer is not obligated to
                      maintain backups.
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Clients are encouraged to make their own backups upon
                  ...
                  <Box sx={{ mb: 2, pageBreakInside: "avoid" }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 0.5, pl: 2 }}>
                      • Both parties agree to work in good faith to resolve any
                      issues amicably.
                    </Typography>
                  </Box>
                </Box>
